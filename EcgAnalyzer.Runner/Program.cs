    ...
    class Program
    {
        ...
        {          
            ...
            var modelParams = new List<WaveformModelParameters>() {
                                                    ...
                                                    new WaveformModelParameters {  States = 2, Symbols = 4},
                                                    new WaveformModelParameters {  States = 2, Symbols = 5},
                                                    new WaveformModelParameters {  States = 3, Symbols = 3},
                                                    new WaveformModelParameters {  States = 3, Symbols = 4},
                                                    new WaveformModelParameters {  States = 3, Symbols = 5},
                                                    new WaveformModelParameters {  States = 4, Symbols = 4},
                                                    new WaveformModelParameters {  States = 4, Symbols = 5},
